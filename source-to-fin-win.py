...
if os.path.exists(os.path.join(os.getcwd(),silent_fin_filename)):
    ...
    print("Удален файл " + os.path.join(os.getcwd(),silent_fin_filename))

#print("Удалим " + os.path.join(os.getcwd(),video_filename))
#if os.path.exists(os.path.join(os.getcwd(),video_filename)):
#    os.remove(os.path.join(os.getcwd(),video_filename))
#    print("Удален файл " + os.path.join(os.getcwd(),video_filename))

print("Сделано! Видео для загрузки в Youtube в файле " + os.path.join(os.getcwd(),fin_filename))
