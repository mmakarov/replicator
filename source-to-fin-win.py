...
if os.path.exists(os.path.join(os.getcwd(),silent_fin_filename)):
    ...
    print("Removed file " + os.path.join(os.getcwd(),silent_fin_filename))

#print("Remove " + os.path.join(os.getcwd(),video_filename))
#if os.path.exists(os.path.join(os.getcwd(),video_filename)):
#    os.remove(os.path.join(os.getcwd(),video_filename))
#    print("Removed file " + os.path.join(os.getcwd(),video_filename))

print("Done! The YouTube-ready video is in " + os.path.join(os.getcwd(),fin_filename))
