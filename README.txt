...
How to use it: 0. Open the terminal and enter: git clone https://github.com/mmakarov/replicator.git
...
Warning:  comments in sources!

Run 

Add python3.9.1 to PATH
pip3 install -r requirements.txt 
pip3 install -r requirements.txt --target=c:\Users\user\Downloads\replicator\lib (windows)
